...
/*the notices were in 2009 and 2017 and there is no sale date. So, if we are using the notice as 
the reference then 2022 is several years later and I would say those subsidies were still in 
effect after those dates.*/

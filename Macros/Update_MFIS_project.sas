...
%macro Update_MFIS_project( Update_file=, Project_except=, Quiet=Y );
  ...
  ** Project_mfa = All Catalog project records with subsidies flagged with MFIS as source 
  ...
  ** Apply update
  ** Project_mfa_update_a = Initial application of MFIS update to Catalog project records;
